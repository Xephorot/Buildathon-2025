    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Resumen de tu actividad en el sistema</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{mockStats.documentsCount}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{mockStats.activePermissions}</p>
            </div>
          </div>
          <div className="mt-4 flex items-center text-sm">
            <span className="text-gray-600">3 entidades autorizadas</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{mockStats.recentActivity}</p>
            </div>
          </div>
          <div className="mt-4 flex items-center text-sm">
            <span className="text-gray-600">En los últimos 7 días</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mt-4 flex items-center text-sm">
            <span className="text-gray-600">Desde Arbitrum Sepolia</span>
          </div>
        </div>
      </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors">
                ...
                <p className="text-sm font-medium text-gray-900">Gestionar Permisos</p>
              </button>
              ...
              <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-colors">
                ...
                <p className="text-sm font-medium text-gray-900">Ver Auditoría</p>
              </button>
              
              <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-orange-300 hover:bg-orange-50 transition-colors">
      ...
      {/* Estado de la red */}
      <div className="bg-white rounded-lg shadow-md p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Estado de la Red</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center space-x-3">
            <div className="w-3 h-3 bg-green-500 rounded-full"></div>
            <div>
              <p className="text-sm font-medium text-gray-900">Arbitrum Sepolia</p>
              <p className="text-xs text-gray-600">Red activa</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">Contratos Desplegados</p>
              <p className="text-xs text-gray-600">3 contratos activos</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">Gas Estimado</p>
              <p className="text-xs text-gray-600">~0.001 ETH por tx</p>
            </div>
          </div>
        </div>
      </div>
